...
op4[4] = new CriaMenu("Funcionário",null,"consultar_funcionario_frontend.php");
...
op3[4] = new CriaMenu("Funcionário",null,"excluir_funcionario_frontend.php");
...
op2[4] = new CriaMenu("Funcionário",null,"alterar_funcionario_frontend.php");
...
op1[4] = new CriaMenu("Funcionário",null,"incluir_funcionario_frontend.php");
